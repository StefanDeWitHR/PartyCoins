        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dt_lastlogin = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_AspNetUsers_guid", x => x.guid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    curreny = table.Column<string>(nullable: true),
                    dt_created = table.Column<DateTime>(nullable: false),
                    dt_modified = table.Column<DateTime>(nullable: false),
                    kvk_num = table.Column<string>(nullable: true),
                    l_active = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    guid = table.Column<Guid>(nullable: false),
                    adres = table.Column<string>(nullable: true),
                    age_required = table.Column<int>(nullable: false),
                    coord_x = table.Column<string>(nullable: true),
                    coord_y = table.Column<string>(nullable: true),
                    desc = table.Column<string>(nullable: true),
                    dt_created = table.Column<DateTime>(nullable: false),
                    dt_modified = table.Column<DateTime>(nullable: false),
                    dt_party = table.Column<DateTime>(nullable: false),
                    guid_company = table.Column<Guid>(nullable: false),
                    l_active = table.Column<int>(nullable: false),
                    line_up = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Partys", x => x.guid);
                });
