        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LActive = table.Column<int>(nullable: false),
                    PartyId = table.Column<string>(nullable: false),
                    PaymethodId = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(nullable: false),
                    WalletId = table.Column<int>(nullable: false),
                    WalletId1 = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCoin", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserCoin_Wallets_WalletId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartyId1 = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PayMethods_Partys_PartyId1",
                        column: x => x.PartyId1,
                        principalTable: "Partys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
